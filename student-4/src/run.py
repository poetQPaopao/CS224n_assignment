...
if args.function == 'pretrain':
    ...
    ### YOUR CODE HERE ###
    corpus_text = open(args.pretrain_corpus_path, encoding='utf-8').read()
    output_path = args.writing_params_path
    pretrain_dataset = dataset.CharCorruptionDataset(
        corpus_text, block_size)
    ...
    finetune_dataset = dataset.NameDataset(
        pretrain_dataset, finetune_text)
